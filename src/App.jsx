...
foods:{
eat:[
“시금치·소고기·굴 — 철분 보충 (출혈로 손실된 철분 회복에 필수)”,
“미역국·된장국 — 미네랄·전해질 보충, 자궁 회복 지원”,
“생강차·쑥차·계피차 — 혈액순환 도와 생리통 완화, 자궁 따뜻하게”,
“다크 초콜릿 (카카오 70%+) — 마그네슘으로 자궁 경련·두통 완화”,
“연어·고등어·호두 — 오메가3로 프로스타글란딘 억제, 염증 완화”,
“딸기·귤·브로콜리 — 비타민C로 철분 흡수 2–3배 향상”,
“두부·렌틸콩·검은콩 — 식물성 철분 + 단백질”,
],
avoid:[
“커피·녹차 — 카페인이 철분 흡수 방해, 경련 악화”,
“라면·가공식품 — 나트륨 과다로 부종·복부 팽만 심해짐”,
“알코올 — 프로스타글란딘 증가로 생리통 악화”,
“냉음료·아이스크림 — 자궁 수축 유발, 복통 심해짐”,
“날생선·회 — 면역 저하 시기, 식중독 위험 증가”,
],
},
exercise:[
“음인 요가 (Child’s Pose, 비틀기) — 골반 이완, 생리통 완화”,
“복식호흡 명상 10–15분 — 통증 인식 낮추고 이완 유도”,
“가벼운 스트레칭 — 허리·허벅지 안쪽 위주로”,
“느린 산책 20–30분 — 기분 전환, 무리하지 않게”,
],
tips:[
“온찜질을 아랫배에 15–20분 — 혈관 확장으로 경련 완화”,
“수면 7–9시간 우선 확보, 낮잠도 괜찮아요”,
“고강도 운동은 이 시기엔 쉬어가도 돼요”,
“몸이 보내는 신호를 일기에 기록해두면 다음 달 대비 가능”,
],
},
{
id:“choseung”, name:“초승달”, moon:“🌒”, season:“회복기”, dayRange:[6,9],
color:”#7ABEAA”, soft:”#E4F5F0”, border:”#B8DCCF”, text:”#2E6B5A”,
description:“달이 서서히 차오르는 시간. 에너지가 회복되며 몸이 깨어나기 시작해요.”,
keyword:“회복과 새로운 출발”,
nutrients:[“단백질”,“아연”,“비타민B군”,“프로바이오틱스”],
foods:{
eat:[
“김치·요거트·된장 — 프로바이오틱스로 장 건강 회복, 에스트로겐 대사 지원”,
“달걀·닭가슴살·두부 — 단백질로 에너지 회복, 아연 공급”,
“블루베리·딸기 — 항산화로 세포 재생, 비타민C”,
“귀리·현미·퀴노아 — 복합탄수화물로 에너지 안정적 공급”,
“아몬드·호두·해바라기씨 — 아연·마그네슘으로 호르몬 회복 지원”,
“연어·고등어 — 오메가3로 에스트로겐 생성 원료 공급”,
],
avoid:[
“액상과당 음료·사탕 — 인슐린 급등으로 호르몬 교란”,
“초가공식품·패스트푸드 — 트랜스지방이 호르몬 합성 방해”,
“과음 — 간의 에스트로겐 분해 기능 저하”,
],
},
exercise:[
“가벼운 조깅·빠른 걷기 30분 — 에너지 회복에 맞춰 점진적으로”,
“가벼운 근력 운동 — 에스트로겐 상승 시작, 근합성 효율 올라가는 시기”,
“수영·자전거 — 전신 유산소, 부담 없이”,
“필라테스 — 코어 강화, 몸의 균형 회복”,
],
tips:[
“새 프로젝트·목표를 구상하기 시작하세요”,
“수면이 아직 중요해요, 7–8시간 확보”,
“몸이 서서히 깨어나는 중, 무리하지 않게”,
“가벼운 사교 활동부터 시작하기 좋아요”,
],
},
{
...
foods:{
eat:[
“브로콜리·케일·양배추 — 인돌-3-카비놀로 에스트로겐 대사·해독 지원”,
“연어·고등어·참치 — 오메가3로 호르몬 생성 원료, 뇌 기능 향상”,
“아보카도·올리브오일 — 건강한 지방으로 호르몬 균형 유지”,
“렌틸콩·병아리콩 — 식물성 단백질+식이섬유로 에스트로겐 대사 지원”,
“버섯류 (표고·느타리) — 비타민D 공급, 배란 전 면역력 지원”,
“달걀 — 콜린·단백질로 뇌 기능과 근육 합성 지원”,
],
avoid:[
“흰빵·정제 탄수화물 — 에스트로겐 불균형 유발 가능”,
“초가공식품 — 트랜스지방이 호르몬 합성 방해”,
“과도한 알코올 — 간의 에스트로겐 대사 방해”,
],
},
exercise:[
“달리기·수영 30–45분 — 에스트로겐 최고조, 유산소 최적 시기”,
“근력 운동 (스쿼트·데드리프트) — 에스트로겐 덕에 근육 합성 효율 최고”,
“HIIT 20–30분 — 짧고 강하게, 대사 촉진”,
“댄스·줌바 — 사교적 에너지와 운동 효과 동시에”,
],
tips:[
“중요한 프로젝트·발표를 이 시기로 잡으면 유리해요”,
“창의적 작업, 브레인스토밍에 에너지 집중”,
“이 시기 운동 기록이 가장 좋게 나와요”,
“새 기술·학습 시작하기 딱 좋은 때”,
],
},
{
...
foods:{
eat:[
“굴·호박씨·새우 — 아연이 배란 기능 직접 지원 (MDPI 2024)”,
“블루베리·라즈베리·석류 — 항산화로 난자 산화 스트레스 방어”,
“브로콜리·콜리플라워 — 과잉 에스트로겐 배출 도움”,
“달걀·닭가슴살 — 비타민B6로 LH 호르몬 합성 지원”,
“아스파라거스·시금치 — 엽산으로 세포 건강 유지”,
“물 2L+ — 자궁경부 점액 분비 돕고 체온 조절”,
],
avoid:[
“커피 3잔 이상 — 카페인 과잉이 배란 타이밍 교란 가능”,
“알코올 — 에스트로겐 과잉 유발, 배란 억제 가능”,
“튀긴 음식·마가린 — 트랜스지방이 배란 방해”,
“과식 — 소화 부담으로 에너지 저하”,
],
},
exercise:[
“HIIT 30–40분 — 호르몬 최고조, 강도 높여도 회복 빠름”,
“그룹 스포츠 (테니스·배구·농구) — 사교 에너지 폭발하는 시기”,
“사이클링·달리기 인터벌 — 심폐 기능 강화”,
“새 운동 클래스 도전 — 학습 능력도 피크, 동작 습득 빠름”,
],
tips:[
“중요한 발표·협상·면접을 이 시기로 잡으면 유리해요”,
“언어 능력·공감 능력 최고조, 소통이 필요한 일에 집중”,
“자신감 있게 의사 표현하기 좋은 때”,
“에너지 발산 위한 사회 활동 적극 계획”,
],
},
{
id:“hahyun”, name:“하현달”, moon:“🌖”, season:“안정기”, dayRange:[17,23],
color:”#C27A5A”, soft:”#F8EDE9”, border:”#E0C4B8”, text:”#7A4530”,
description:“달이 포근하게 기울기 시작하는 시간. 나에게로 돌아오는 시간. 안정적이고 내향적인 에너지예요.”,
keyword:“돌봄과 정리”,
nutrients:[“복합탄수화물”,“칼슘”,“마그네슘”,“트립토판”],
foods:{
eat:[
“고구마·단호박·현미 — 복합탄수화물이 세로토닌 생성 촉진, 혈당 안정”,
“닭고기·달걀·피스타치오 — 비타민B6로 세로토닌·멜라토닌 합성 지원”,
“우유·치즈·두부·브로콜리 — 칼슘이 PMS 전조 증상 완화”,
“바나나·아몬드·시금치 — 마그네슘으로 근육 이완, 수면 개선”,
“캐모마일·라벤더차 — 불안 완화, 수면의 질 향상”,
“연어·호두·치아씨드 — 오메가3로 염증 예방”,
],
avoid:[
“카페인 음료 — 수면 방해, 불안감 증폭”,
“알코올 — 프로게스테론 대사 방해, 수면의 질 저하”,
“정제 탄수화물·흰빵 — 혈당 스파이크 후 기분 급변”,
“짠 음식·가공육 — 부종 악화, PMS 전조”,
],
},
exercise:[
“요가·필라테스 40–50분 — 코어 강화, 복부 팽만 완화”,
“가벼운 유산소 (빠른 걷기·자전거) — 엔도르핀으로 기분 전환”,
“자연 속 산책 30–40분 — 코르티솔 낮추고 마음 안정”,
“스트레칭·폼롤링 — 긴장된 몸 풀어주기”,
],
tips:[
“정리·마무리 작업에 집중하기 좋은 때”,
“혼자만의 창의적 작업, 독서에 에너지 집중”,
“취침 1시간 전 화면 끄고 수면의 질 챙기기”,
“감정 일기 쓰기 — 내면 탐색의 좋은 기회”,
],
},
{
...
foods:{
eat:[
“다크 초콜릿·시금치·아몬드 — 마그네슘으로 PMS 경련·불안·두통 완화 (ACOG 2023)”,
“우유·두부·케일 — 칼슘이 PMS 신체 증상 완화 (Cambridge 메타분석 2023)”,
“닭고기·바나나·피스타치오 — 비타민B6로 기분 조절 호르몬 합성 지원”,
“연어·호두·치아씨드 — 오메가3로 염증·우울감 완화”,
“고구마·바나나·토마토 — 칼륨으로 붓기·수분 저류 감소”,
“생강·강황차 — 항염증, 경련 완화, 소화 지원”,
],
avoid:[
“짠 음식·가공육·라면 — 붓기·수분 저류 악화”,
“커피·에너지음료 — 불안·수면 방해, PMS 증상 심화”,
“알코올 — 세로토닌 감소로 우울감·예민함 악화”,
“설탕·흰빵·과자 — 혈당 급등 후 폭락으로 기분 급변”,
],
},
exercise:[
“스트레칭·음인 요가 — 몸이 무거울 때 무리 없이 이완”,
“가벼운 산책 20–30분 — 엔도르핀 소량 분비로 기분 전환”,
“명상·호흡 운동 — 예민한 신경계 안정”,
“따뜻한 목욕 후 스트레칭 — 근육 이완, 수면 개선”,
],
tips:[
“PMS는 자연스러운 신호예요, 몸을 탓하지 말고 돌봐주세요”,
“중요한 결정과 감정적인 대화는 가능하면 미루세요”,
“충분한 수면과 혼자만의 시간을 확보하세요”,
“증상이 심하면 산부인과 상담을 권해요”,
],
},
];
...
wolsik: {
spring:[“달래·냉이 — 철분+비타민C (철분 흡수 향상에 최고)”,“바지락·주꾸미 — 타우린+철분 보충”,“딸기 — 비타민C로 철분 흡수 2–3배 향상”,“봄동 — 엽산+칼슘, 자궁 회복 지원”],
summer:[“깻잎·낙지 — 철분+타우린 (여름 철분 보충)”,“전복 — 아연+철분, 스태미나 보충”,“토마토·딸기 — 비타민C로 철분 흡수 향상”,“수박 — 수분+칼륨, 붓기 완화”],
autumn:[“연근·우엉 — 철분+식이섬유 (혈액 정화)”,“갈치·꽁치 — 오메가3 (염증 완화)”,“사과·배 — 비타민C+식이섬유”,“버섯류 — 비타민D+셀레늄”],
winter:[“시금치 — 철분+마그네슘 (겨울 최고 철분원)”,“굴 — 아연+철분+타우린”,“귤·한라봉 — 비타민C로 철분 흡수 향상”,“꼬막 — 철분+단백질”],
},
choseung: {
spring:[“봄동·유채나물 — 엽산+비타민 (에너지 회복)”,“도다리·도미 — 단백질 (세포 회복 지원)”,“딸기 — 비타민C+항산화”,“달래 — 아연+알리신 (면역 회복)”],
summer:[“오이·애호박 — 수분+비타민 (장 환경 개선)”,“재첩·바지락 — 아연+타우린”,“자두·복숭아 — 항산화+비타민C”,“장어 — 단백질+비타민B군”],
autumn:[“사과·배 — 식이섬유+비타민C”,“전어 — 단백질+오메가3”,“고구마 — 비타민B+복합탄수화물”,“포도 — 레스베라트롤+항산화”],
winter:[“봄동·유채나물 — 엽산+칼슘”,“도미·꼬막 — 단백질+아연”,“한라봉·귤 — 비타민C”,“김·파래 — 아이오딘+식이섬유”],
},
sanghyun: {
spring:[“두릅·미나리 — 인돌+식이섬유 (에스트로겐 대사)”,“꽃게 — 비타민D+아연”,“딸기 — 항산화”,“쑥갓 — 엽산+비타민K”],
summer:[“브로콜리·애호박 — 인돌-3-카비놀 (에스트로겐 해독)”,“참치·장어 — 오메가3+비타민D”,“복숭아 — 항산화+수분”,“가지 — 안토시아닌+항산화”],
autumn:[“브로콜리·무 — 인돌+식이섬유”,“꽃게·대하 — 비타민D+아연”,“배·포도 — 항산화”,“버섯류 — 비타민D+셀레늄”],
winter:[“김·파래 — 아이오딘+식이섬유”,“굴 — 아연+비타민D”,“귤 — 비타민C”,“시금치 — 엽산+철분”],
},
boreum: {
spring:[“멍게·키조개 — 아연 (배란 직접 지원)”,“딸기·상추 — 비타민C+수분”,“바지락 — 아연+철분”,“아스파라거스 — 엽산+항산화”],
summer:[“전복 — 아연 (배란 기능 최적 지원)”,“수박·오이·토마토 — 수분+항산화”,“가지 — 항산화+수분”,“오이 — 수분 보충, 체온 조절”],
autumn:[“대하·꽃게 — 아연+셀레늄”,“포도·무화과 — 항산화”,“버섯류 — 셀레늄+비타민D”,“사과 — 비타민C+항산화”],
winter:[“굴·꼬막 — 아연+셀레늄 (배란 지원)”,“귤 — 비타민C”,“파래·김 — 아이오딘”,“시금치 — 엽산+비타민K”],
},
hahyun: {
spring:[“완두콩·재첩 — 트립토판+칼슘 (세로토닌 생성)”,“부추 — 비타민B6+칼슘”,“매실 — 해독+소화 지원”,“쑥갓 — 칼슘+마그네슘”],
summer:[“옥수수·깻잎 — 복합탄수화물+칼슘”,“낙지 — 타우린+마그네슘”,“복숭아 — 수분+칼륨”,“애호박 — 식이섬유+비타민B”],
autumn:[“고구마·단호박 — 복합탄수화물+베타카로틴”,“밤 — 칼슘+복합탄수화물”,“전어 — 오메가3+단백질”,“감 — 비타민C+탄닌”],
winter:[“우엉·연근 — 식이섬유+마그네슘”,“굴 — 칼슘+아연”,“귤 — 비타민C+항산화”,“고구마 — 복합탄수화물+칼륨”],
},
geumeum: {
spring:[“시금치·달래 — 마그네슘+칼륨 (PMS 완화)”,“딸기 — 비타민C+항산화”,“두릅·미나리 — 비타민B+해독”,“바나나 — 칼륨+트립토판 (붓기 완화)”],
summer:[“깻잎·수박 — 마그네슘+칼륨 (붓기 완화)”,“옥수수 — 복합탄수화물+칼륨”,“낙지 — 마그네슘+타우린”,“복숭아 — 칼륨+수분”],
autumn:[“고구마·감 — 칼륨 (붓기·수분 저류 완화)”,“굴 — 마그네슘+칼슘+아연 (PMS 3중 지원)”,“사과 — 비타민C+항산화”,“단호박 — 베타카로틴+칼슘”],
winter:[“시금치·우엉 — 마그네슘+철분”,“굴 — 칼슘+마그네슘+아연 (PMS 3중 지원)”,“귤·한라봉 — 비타민C”,“고구마 — 칼륨+복합탄수화물”],
},
};
...
let sk;
if (m >= 3 && m <= 5) sk = “spring”;
else if (m >= 6 && m <= 8) sk = “summer”;
else if (m >= 9 && m <= 11) sk = “autumn”;
else sk = “winter”;
return PHASE_SEASON_FOODS[phaseId]?.[sk] || [];
}

// ── 초승달을 12시(0°)에서 시작 ──
// 초승달(4일) → 상현달(4일) → 보름달(3일) → 하현달(7일) → 그믐달(5일) → 월식(5일)
const PA = [
...
seasonalFoods:[
“달래·냉이·쑥 — 봄나물은 비타민·미네랄·엽산 풍부”,
“딸기 — 비타민C 풍부, 철분 흡수 향상, 항산화”,
“두릅·아스파라거스 — 인돌 성분, 호르몬 대사 지원”,
“봄동·쑥갓 — 칼슘·마그네슘·엽산 풍부”,
“주꾸미·바지락 — 타우린+철분+아연, 전반적 회복에”,
],
...
seasonalFoods:[
“수박·참외 — 수분 보충, 칼륨으로 붓기 완화”,
“오이·토마토 — 수분 92%+, 비타민C+항산화”,
“깻잎 — 칼슘·마그네슘·철분 풍부 (국내 최고 칼슘원)”,
“낙지·재첩 — 타우린+마그네슘, 피로 회복”,
“매실 — 구연산+소화 효소, 더위 속 소화 지원”,
],
...
seasonalFoods:[
“전복·오징어 — 아연+타우린, 여름 보양+배란 지원”,
“수박·복숭아·포도 — 수분+칼륨, 붓기 완화”,
“토마토 — 라이코펜+비타민C, 자외선 손상 방어”,
“옥수수 — 복합탄수화물+칼륨, 혈당 안정”,
“깻잎 — 칼슘+마그네슘+철분 동시 보충”,
],
...
seasonalFoods:[
“굴·꽃게·대하 — 아연+칼슘+셀레늄 (PMS·배란 다방면 지원)”,
“고구마·단호박·밤 — 복합탄수화물+칼륨+칼슘”,
“버섯류 (송이·표고) — 비타민D+셀레늄+면역 지원”,
“사과·배·포도 — 비타민C+식이섬유+항산화”,
“갈치·꽁치·전어 — 오메가3 최고치, 염증 완화”,
],
...
seasonalFoods:[
“굴·꼬막 — 아연+철분+칼슘+마그네슘 (겨울 최강 보충원)”,
“시금치·배추 — 철분+마그네슘+엽산 풍부”,
“귤·한라봉 — 비타민C로 철분 흡수 향상, 면역력”,
“대구·방어 — 오메가3+단백질+비타민D”,
“생강차·유자차 — 항염증+혈액순환, 자궁 따뜻하게”,
],
...
if (day <= 5)  return PHASES[0]; // 월식
if (day <= 9)  return PHASES[1]; // 초승달
if (day <= 13) return PHASES[2]; // 상현달
if (day <= 16) return PHASES[3]; // 보름달
if (day <= 23) return PHASES[4]; // 하현달
return PHASES[5];                // 그믐달
}
...
// 초승달(Day 6)이 12시(0°)에 오도록 — 월식 5일 분량만큼 오프셋
...
// 호의 각도 크기에 따라 폰트 크기 조정
function arcFontSize(pa) {
const span = pa.e - pa.s;
if (span < 42) return “8.5”;
if (span < 60) return “9.5”;
return “10.5”;
}
...
{stats.inFertile ? (
<div style={{ fontSize:14, fontWeight:700, color:PHASES[3].color, lineHeight:1.3 }}>가임기<br/>진행 중</div>
) : (
<>
...
return distEnd <= 7 && ds > p.start;
});
}

function handleDayTap(ds) {
const period = getPeriodForDay(ds);
if (period) { setModal({ ds, mode: “menu”, period }); return; }
const nearby = findNearbyPeriod(ds);
if (nearby) { setModal({ ds, mode: “edit”, period: nearby }); }
else { setModal({ ds, mode: “action” }); }
}
  ...
  <div style={{ display:"flex", gap:8, flexWrap:"wrap", marginBottom:14 }}>
    ...
    <div style={{ display:"flex", alignItems:"center", gap:4 }}>
      <div style={{ width:12, height:12, borderRadius:3, background:"transparent",
        border:`1.5px dashed ${PHASES[3].color}`,
        position:"relative", display:"flex", alignItems:"center", justifyContent:"center" }}>
        <div style={{ width:4, height:4, borderRadius:"50%", background:PHASES[3].color }} />
      </div>
  ...
  <div style={{ display:"grid", gridTemplateColumns:"repeat(7,1fr)", gap:3 }}>
    {cells.map((ds, i) => {
      ...
      if (inPeriod) {
        ...
        bg = PHASES[3].soft; borderStyle = `2px solid ${PHASES[3].color}`; col = PHASES[3].text;
        extra = <div style={{ position:"absolute", top:2, right:3, fontSize:8, color:PHASES[3].color, fontWeight:700 }}>●</div>;
      } else if (inFertile) {
        bg = "transparent"; borderStyle = `1.5px dashed ${PHASES[3].color}`; col = PHASES[3].text;
        extra = <div style={{ width:3.5, height:3.5, borderRadius:"50%", background:PHASES[3].color, position:"absolute", bottom:2 }} />;
      } else if (ph) {
    ...
    <div style={{ marginTop:14, background:C.card, border:`1px solid ${C.border}`, borderRadius:14, padding:"13px 15px" }}>
      ...
      <div style={{ display:"grid", gap:6 }}>
        {[
          ...
          { label:"배란 예정", date:stats.ovulation, color:PHASES[3].text, bg:PHASES[3].soft, border:PHASES[3].border, emoji:"🌕" },
          { label:"가임기 시작", date:stats.fertileStart, color:PHASES[3].text, bg:PHASES[3].soft, border:PHASES[3].border, emoji:"🌓" },
        ].map(s => (
      ...
      <div onClick={e => e.stopPropagation()} style={{
        ...
        {modal.mode === "action" && (
          <div style={{ display:"grid", gap:10 }}>
            <button onClick={() => addStart(modal.ds)} style={{ padding:"15px", background:PHASES[0].soft, border:`1.5px solid ${PHASES[0].border}`, borderRadius:14, fontSize:14, fontWeight:700, color:PHASES[0].text, cursor:"pointer" }}>
              🌑 생리 시작일로 기록
            </button>
            <button onClick={() => addEnd(modal.ds)} style={{ padding:"15px", background:C.card, border:`1.5px solid ${C.border}`, borderRadius:14, fontSize:14, fontWeight:600, color:C.text, cursor:"pointer" }}>
              ✓ 생리 종료일로 기록
            </button>
        ...
        {modal.mode === "edit" && modal.period && (
          <div style={{ display:"grid", gap:10 }}>
            ...
            <button onClick={() => editEnd(modal.period.id, modal.ds)} style={{ padding:"14px", background:PHASES[0].soft, border:`1.5px solid ${PHASES[0].border}`, borderRadius:14, fontSize:14, fontWeight:700, color:PHASES[0].text, cursor:"pointer" }}>
              ✓ 종료일을 {fmtKo(modal.ds)}로 수정
            </button>
            <button onClick={() => setModal({ ...modal, mode:"action" })} style={{ padding:"14px", background:C.card, border:`1.5px solid ${C.border}`, borderRadius:14, fontSize:13, fontWeight:600, color:C.muted, cursor:"pointer" }}>
              + 새 기록으로 추가
            </button>
            <button onClick={() => setModal(null)} style={{ padding:"12px", background:"transparent", border:"none", fontSize:13, color:C.muted, cursor:"pointer" }}>취소</button>
          </div>
        ...
        {modal.mode === "menu" && modal.period && (
          <div style={{ display:"grid", gap:10 }}>
            ...
            <button onClick={() => editEnd(modal.period.id, modal.ds)} style={{ padding:"14px", background:C.card, border:`1.5px solid ${C.border}`, borderRadius:14, fontSize:14, fontWeight:600, color:C.text, cursor:"pointer" }}>
              ✓ 종료일을 {fmtKo(modal.ds)}로 변경
            </button>
            <button onClick={() => deletePeriod(modal.period.id)} style={{ padding:"14px", background:"#FEF2F2", border:"1.5px solid #FECACA", borderRadius:14, fontSize:14, fontWeight:600, color:"#EF4444", cursor:"pointer" }}>
              🗑 이 기록 삭제
            </button>
            <button onClick={() => setModal(null)} style={{ padding:"12px", background:"transparent", border:"none", fontSize:13, color:C.muted, cursor:"pointer" }}>취소</button>
          </div>
...
const years  = Array.from({length:5}, (*,i) => now.getFullYear()-2+i);
const months = Array.from({length:12}, (*,i) => i+1);
...
if (AD_PROVIDER === “kakao” && window.kakaoAdfit) { window.kakaoAdfit.load(); }
}, []);
...
return (
<div style={{ height: h, background:”#F7F5F0”, border:“1.5px dashed #D4CFC6”, borderRadius: type === “banner” ? 0 : 14, display:“flex”, flexDirection:“column”, alignItems:“center”, justifyContent:“center”, gap:4 }}>
<div style={{ fontSize:10, color:”#B0AA9E”, fontWeight:600, letterSpacing:“0.05em” }}>AD</div>
<div style={{ fontSize:9, color:”#D4CFC6” }}>Kakao AdFit · AdSense · AdMob</div>
</div>
);
}
...
return (
<div style={{ minHeight:“100vh”, background:C.bg, fontFamily:“DM Sans,sans-serif”, display:“flex”, flexDirection:“column”, alignItems:“center”, justifyContent:“center”, padding:“32px 28px” }}>
...
<p style={{ fontSize:14, color:C.muted, lineHeight:1.8 }}>나의 사이클 데이터를 안전하게 보관하고<br/>어느 기기에서든 이어서 사용할 수 있어요.</p>
</div>
<button onClick={handleGoogle} disabled={loading} style={{ width:“100%”, maxWidth:320, padding:“15px 20px”, background:“white”, border:`1.5px solid ${C.border}`, borderRadius:14, cursor:loading ? “default” : “pointer”, display:“flex”, alignItems:“center”, justifyContent:“center”, gap:12, boxShadow:“0 2px 12px rgba(0,0,0,0.07)”, opacity: loading ? 0.7 : 1 }}>
...
<button onClick={handleApple} disabled={loading} style={{ width:“100%”, maxWidth:320, padding:“15px 20px”, marginTop:10, background:“black”, border:“1.5px solid black”, borderRadius:14, cursor:loading ? “default” : “pointer”, display:“flex”, alignItems:“center”, justifyContent:“center”, gap:12, boxShadow:“0 2px 12px rgba(0,0,0,0.15)”, opacity: loading ? 0.7 : 1 }}>
...
{error && <p style={{ marginTop:14, fontSize:12, color:”#EF4444”, textAlign:“center” }}>{error}</p>}
<p style={{ marginTop:28, fontSize:11, color:C.muted, textAlign:“center”, lineHeight:1.7, maxWidth:280 }}>
로그인하면 생리 기록이 안전하게 클라우드에 저장돼요.<br/>이름·이메일 외 개인정보는 수집하지 않아요.
</p>
</div>
);
}
...
return (
<div onClick={() => onChange(!on)} style={{ width:44, height:24, borderRadius:12, flexShrink:0, cursor:“pointer”, background: on ? PHASES[1].color : “#D4CFC6”, position:“relative”, transition:“background 0.2s” }}>
<div style={{ position:“absolute”, top:3, left: on ? 22 : 3, width:18, height:18, borderRadius:“50%”, background:“white”, boxShadow:“0 1px 4px rgba(0,0,0,0.15)”, transition:“left 0.2s” }}/>
</div>
);
}
...
return raw ? JSON.parse(raw) : { period3: true, period1: true, fertile: true, ovulation: true, phaseChange: true, dailyTip: false, hour: 8 };
...
{ key:“phaseChange”,label:“시기 변경”,           desc:“새 달 위상 시작일 알림” },
{ key:“dailyTip”,   label:“오늘의 팁”,           desc:“현재 위상 맞춤 조언” },
];
...
```
  ...
  <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:10, marginBottom:22 }}>
    {[
      ...
      { l:"총 기록 횟수",   v:`${periods.length}회`,                   sub:"누적",       ph:PHASES[5] },
      { l:"이번 사이클",   v: stats ? `${stats.cycleDay}일차` : "-", sub:`/ ${stats?.avgCycle||28}일`, ph:PHASES[3] },
    ].map(s => (
  ...
  <div style={{ background:C.card, border:`1px solid ${C.border}`, borderRadius:16, overflow:"hidden", marginBottom:12, boxShadow:"0 1px 6px rgba(0,0,0,0.04)" }}>
    {notifPerm !== "granted" && (
      <div style={{ padding:"13px 16px", background: notifPerm==="denied"?"#FEF2F2":PHASES[1].soft, borderBottom:`1px solid ${C.border}`, display:"flex", alignItems:"center", justifyContent:"space-between", gap:10 }}>
        <div style={{ fontSize:12, color: notifPerm==="denied"?"#EF4444":PHASES[1].text, lineHeight:1.5 }}>
          {notifPerm==="denied" ? "알림이 차단됐어요. 브라우저 설정에서 허용해주세요." : "알림을 받으려면 권한이 필요해요"}
        </div>
        {notifPerm !== "denied" && (
          <button onClick={async () => { const p = await Notification.requestPermission(); setNotifPerm(p); }} style={{ flexShrink:0, padding:"6px 14px", background:PHASES[1].color, border:"none", borderRadius:100, color:"white", fontSize:12, fontWeight:700 }}>허용하기</button>
        )}
      </div>
    )}
    <div style={{ padding:"14px 16px", borderBottom:`1px solid ${C.border}`, display:"flex", alignItems:"center", justifyContent:"space-between" }}>
      ...
      <select value={prefs.hour} onChange={e => set("hour", +e.target.value)} style={{ background:C.bg, border:`1px solid ${C.border}`, borderRadius:8, color:C.text, padding:"7px 10px", fontSize:13, outline:"none", fontFamily:"DM Sans,sans-serif" }}>
  ...
  <button onClick={() => requestAndNotify("🌙 Me:ll", stats ? `오늘은 ${stats.phase.name} ${stats.cycleDay}일차예요 — ${stats.phase.keyword}` : "생리 기록을 추가해보세요!")} style={{ width:"100%", padding:"13px", marginBottom:20, background:"white", border:`1.5px solid ${C.border}`, borderRadius:14, color:C.text, fontSize:13, fontWeight:600, boxShadow:"0 1px 4px rgba(0,0,0,0.05)" }}>
    테스트 알림 보내기
  </button>
  ...
  <div style={{ background:"#F0F4FF", border:"1px solid #C5CEF0", borderRadius:14, padding:"14px 16px", marginBottom:20 }}>
    ...
    <div style={{ fontSize:11.5, color:"#6674C0", lineHeight:1.7 }}>
      Capacitor 앱으로 출시하면 <strong>Local Notifications</strong>으로 전환돼요. 앱이 꺼져 있어도 알림이 와요.
    </div>
  </div>
    ...
    {PHASES.map(p => (
      <div key={p.id} style={{ background:C.card, border:`1px solid ${C.border}`, borderRadius:14, padding:"13px 15px", boxShadow:"0 1px 4px rgba(0,0,0,0.04)" }}>
        <div style={{ display:"flex", alignItems:"center", gap:9, marginBottom:5 }}>
          <div style={{ fontSize:20, flexShrink:0 }}>{p.moon}</div>
          <div>
        ...
        <div style={{ display:"flex", flexWrap:"wrap", gap:4, marginTop:7 }}>
          {p.nutrients.map(n => (
            <span key={n} style={{ fontSize:9.5, padding:"2px 8px", background:p.soft, color:p.text, borderRadius:100, border:`1px solid ${p.border}`, fontWeight:600 }}>{n}</span>
          ))}
        </div>
      </div>
    ))}
  ...
  <div style={{ marginTop:24, background:C.card, border:`1px solid ${C.border}`, borderRadius:16, padding:"16px 18px", boxShadow:"0 1px 5px rgba(0,0,0,0.04)" }}>
    ...
    <div style={{ display:"grid", gap:10 }}>
      {[
        { label:"달 위상 사이클 프레임워크", src:"월경(月經)의 月에서 영감 받아 독자적으로 고안 · © 2026 hhappyfamilydais" },
        { label:"PMS 진단 기준 (5일)", src:"ACOG Clinical Practice Guideline — Management of Premenstrual Disorders (2023)" },
        { label:"영양소·무기질 근거", src:"PMC Minerals & Menstrual Cycle (2024) · Cambridge Nutrition Research Reviews (2023) · MDPI Nutrients (2024)" },
        { label:"호르몬·시기별 특성", src:"Cleveland Clinic · 대한산부인과학회 생리주기 가이드라인" },
  ...
  <div style={{ marginTop:12, marginBottom:8, padding:"14px 16px", background:"#F7F5F0", borderRadius:14, border:`1px solid ${C.border}` }}>
    ...
    <p style={{ margin:0, fontSize:10.5, color:C.muted, lineHeight:1.75 }}>
      본 앱이 제공하는 생리 예측, 가임기, 임신 확률 및 건강 정보는 <strong style={{ color:C.text }}>일반적인 통계와 참고 자료</strong>에 기반하며, 개인의 건강 상태에 따라 실제와 다를 수 있습니다. 본 정보는 <strong style={{ color:C.text }}>의학적 진단, 치료 또는 처방을 대체하지 않습니다.</strong> 임신 계획, 피임, 건강 이상 증상 등에 대해서는 반드시 산부인과 전문의와 상담하세요.
    </p>
  </div>

  <div style={{ textAlign:"center", padding:"12px 0 4px" }}>
    <div style={{ fontSize:10, color:"#C4BFB8" }}>v2.0.0 · Me:ll 🌙</div>
...
return (
<div onClick={() => window.open(APP_URL, “_blank”)} style={{ background: C.bg, fontFamily:“DM Sans,sans-serif”, cursor:“pointer”, userSelect:“none”, minHeight:“100vh”, padding:“0 0 16px”, position:“relative” }}>
<style>{`@import url('https://fonts.googleapis.com/css2?family=DM+Sans:wght@400;500;600;700&family=DM+Serif+Display&display=swap');*{box-sizing:border-box;margin:0;padding:0}`}</style>
...
<>
<Clock angle={stats.angle} selId={dp?.id} todayId={dp?.id} onSelect={() => {}} ready={ready} cycleDay={stats.cycleDay} totalDays={stats.avgCycle} />
{dp && (
...
<div style={{ fontSize:20, fontFamily:“DM Serif Display,serif”, color:dp.text }}>{dp.moon} {dp.name}</div>
...
<style>{`@import url('https://fonts.googleapis.com/css2?family=DM+Sans:wght@400;500;600;700&family=DM+Serif+Display&display=swap'); *{box-sizing:border-box;margin:0;padding:0} button{cursor:pointer;font-family:inherit}`}</style>
          ...
          {dp && (
            <div style={{ background:C.card, border:`1px solid ${dp.border}`, borderRadius:20, padding:"16px 18px", marginBottom:12, boxShadow:"0 2px 14px rgba(0,0,0,0.05)", transition:"border-color 0.3s" }}>
              ...
              <div style={{ display:"flex", flexWrap:"wrap", gap:5, marginTop:10 }}>
                {dp.nutrients?.map(n => (
                  <span key={n} style={{ fontSize:10, padding:"3px 9px", background:dp.soft, color:dp.text, borderRadius:100, border:`1px solid ${dp.border}`, fontWeight:600 }}>{n}</span>
                ))}
              </div>
              {isToday && stats && (
                <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr 1fr", gap:7, marginTop:12 }}>
                  ...
                  <MiniStat label="이 위상" value={`${stats.dIn}일째`} sub={`/${stats.dTotal}일`} soft={dp.soft} textColor={dp.text} />
                  <MiniStat label="다음 위상" value={`${stats.dLeft}일`} sub="후" soft={dp.soft} textColor={dp.text} />
                </div>
              )}
            </div>
          )}
                  ...
                  <div style={{ marginTop:14, paddingTop:12, borderTop:`1px dashed ${seasonInfo.border}` }}>
                    <div style={{ display:"flex", alignItems:"center", gap:6, marginBottom:8 }}>
                      ...
                      <span style={{ fontSize:11, fontWeight:700, color:seasonInfo.color }}>
                        {seasonInfo.name} 제철 × {dp.name} 맞춤 식재료
                      </span>
                    </div>
                    <ul style={{ paddingLeft:0, listStyle:"none", margin:0 }}>
                      {getPhaseSeasonalFoods(dp.id).map((f, i) => {
                        const parts = f.split(" — ");
                        const arr = getPhaseSeasonalFoods(dp.id);
                        return (
                          <li key={i} style={{ display:"flex", alignItems:"flex-start", gap:10, padding:"6px 0", borderBottom: i < arr.length-1 ? `1px solid ${seasonInfo.border}44` : "none" }}>
                            <span style={{ width:5, height:5, borderRadius:"50%", background:seasonInfo.color, flexShrink:0, marginTop:6, opacity:0.8 }}/>
                            <div>
              ...
              return (
                <button key={p.id} onClick={() => togglePhase(p.id)} style={{ background: on ? p.soft : C.card, border:`1.5px solid ${on ? p.border : C.border}`, borderRadius:14, padding:"12px 13px", textAlign:"left", color:C.text, boxShadow: on ? "0 2px 12px rgba(0,0,0,0.07)" : "0 1px 4px rgba(0,0,0,0.03)", transition:"all 0.22s" }}>
                  <div style={{ display:"flex", justifyContent:"space-between", marginBottom:4 }}>
                    <span style={{ fontSize:14, color: on ? p.text : C.text, fontWeight:700 }}>{p.moon} {p.name}</span>
